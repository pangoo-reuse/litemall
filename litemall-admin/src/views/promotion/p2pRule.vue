<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-button v-permission="['GET /admin/p2p/list']" class="filter-item" type="primary" icon="el-icon-search"
                 @click="getList">查找
      </el-button>
      <el-button v-permission="['POST /admin/p2p/create']" class="filter-item" type="primary" icon="el-icon-edit"
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :model="dataForm" :rules="rules" ref="dataForm">
        ...
        <el-table :data="dataForm.products" stripe border style="width: 100%" size="mini">
          ...
          <el-table-column :label="dataForm.unit == undefined ? '数量':'数量/'+dataForm.unit " align="center"
                           valign="center">
            <template slot-scope="scope">
          ...
          <el-table-column :label="dataForm.unit == undefined ? '最低售价(元)':'最低售价(元)/'+dataForm.unit  " align="center"
                           valign="center">
            <template slot-scope="scope">
          ...
          <el-table-column label="是否启用" align="center" valign="center">
            <template slot-scope="scope">
              <el-form-item prop="enabled">
                <el-checkbox :label="true" v-model="scope.row.enabled">启用</el-checkbox>
              </el-form-item>
            </template>
          </el-table-column>
        ...
        methods: {
            ...
            createData() {
                this.$refs['dataForm'].validate(valid => {
                    let products = this.dataForm.products.filter(product => product.enabled);
